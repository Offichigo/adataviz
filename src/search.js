...
export const searchCities = async () => {
  document.querySelector("#search").addEventListener("keypress", async (e) => {
    if (e.code === "Enter") {
      ...
      const url = `https://data.nantesmetropole.fr/api/explore/v2.1/catalog/datasets/244400404_toilettes-publiques-nantes-metropole/records?where=quartier="${getCities}"&limit=-1&refine=pole%3A%22Nantes%20Centralit%C3%A9%22`;
      try {
